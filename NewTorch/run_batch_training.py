...
learning_betas = [0.0, 0.01, 0.02, 0.05, 0.1, 0.2]
# learning_betas = [0.5, 1.0, 2.0, 5.0, 10.0, 20.0, 50.0]
# learning_betas = [0.0]
# learning_betas = [0.01]
# learning_betas = [0.1]
if params['env_name']=="WarmStart":
    ...
    # learning_betas = [100000]
for learning_beta in learning_betas:
    func = f"""python train_DDQN.py --learning_beta {learning_beta}"""
