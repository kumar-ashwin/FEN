...
M = MatthewEnvt(n_agents=n_agents, n_resources=n_resources, max_size=max_size, reallocate=args.reallocate, simple_obs=args.simple_obs, warm_start=args.warm_start, past_discount=args.past_discount, GAMMA=train_args.GAMMA)
...
while i_episode<args.n_episode:
	...
	print("Sizes", [round(x,2) for x in M.size])
