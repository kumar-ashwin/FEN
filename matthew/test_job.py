...
mode+= "/TestJob/" #Only for testing new features
network_type = ""
if multi_head:
...
M = JobSchedulingEnvt(n_agents, gridsize=gridsize, reallocate=reallocate, simple_obs=simple_obs, warm_start=warm_start, past_discount=past_discount,)
