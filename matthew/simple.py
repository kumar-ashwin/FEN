...
from Environment import SimpleEnvt
...
args, train_args = process_args(env_name='Simple')
...
M = SimpleEnvt(n_agents, reallocate=args.reallocate, simple_obs=args.simple_obs, warm_start=args.warm_start, past_discount=args.past_discount,)
...
while i_episode<args.n_episode:
	...
	if i_episode%train_args.validation_freq==0 and args.training:
		...
		if  update and best_val_objective<mean_val_metrics['objective'] and i_episode>=20: #At least 20 episodes before trying to save a best model.
