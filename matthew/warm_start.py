...
args, train_args = process_args(env_name='WarmStart')
...
M = WarmStartEnvt(n_agents, reallocate=args.reallocate, simple_obs=args.simple_obs, warm_start=args.warm_start, past_discount=args.past_discount,)
